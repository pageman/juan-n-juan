...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require 'C:\\xampp\\htdocs\\juan-n-juan\\vendor\\nesbot\\carbon\\src\\Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
namespace CoreProc\JuanNJuan\Providers;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->bind('Illuminate\\Contracts\\Auth\\Registrar', 'CoreProc\\JuanNJuan\\Services\\Registrar');
    }
}
namespace CoreProc\JuanNJuan\Providers;
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'CoreProc\\JuanNJuan\\Commands', 'CoreProc\\JuanNJuan\\Handlers\\Commands');
        });
    }
    public function register()
    {
...
class RouteServiceProvider extends ServiceProvider
{
    protected $namespace = 'CoreProc\\JuanNJuan\\Http\\Controllers';
    public function boot(Router $router)
    {
        parent::boot($router);
    }
