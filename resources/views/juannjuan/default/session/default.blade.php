...
@section('body')
  <div data-ng-controller="SessionCtrl as ctrl" data-ng-init="ctrl.selectChannel({{ $session_id }})">
    <div class="session__stream paneling-container">
      <div class="paneling-sidebar paneling-sidebar--left">
        <a href="#" data-ng-click="ctrl.selectChannel(channel.id)" data-ng-repeat="channel in ctrl.channels">
          <div class="media">
